...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-29 17:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0bd5c671-9998-4005-a2f2-fbbdf64c952e.git
$ cd 0bd5c671-9998-4005-a2f2-fbbdf64c952e
```
